...
{"aesthetic":0.0,"smile":false,"eyesOpen":true,"faces":0,"emotion":"","moment":""}
...
// Métricas de caras con AWS Rekognition (sonrisa, ojos, emoción). null si off.
export async function analyzeFacesAWS(
  bytes: Buffer,
): Promise<Pick<AiPhotoScore, "smile" | "eyesOpen" | "faces" | "emotion"> | null> {
  ...
  try {
    ...
    if (faces.length === 0)
      return { smile: false, eyesOpen: false, faces: 0, emotion: "neutral" };
